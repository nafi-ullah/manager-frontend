...
import { role, name } from '@/utils/cookiesNames';
...
const Sidebar : React.FC<MainContentsProps> = ({ toggleDetails, toggleHome, toggleAdministration }) => {
	const [myName, setName] = useState<string>('');
	const [myRole, setRole] = useState<string>('');
  ...
  return (
    <div className="flex flex-col h-screen p-3 w-60 text-gray-50 bg-gray-800">
	...
	<div className="space-y-3">
		...
		<div className="flex-1">
			<ul className="pt-2 pb-4 space-y-1 text-sm">
				<li className="rounded-sm hover:bg-black">
				...
				<li  onClick={toggleAdministration} className="rounded-sm hover:bg-black">
					<a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
				...
				<li onClick={logOutButton} className="rounded-sm">
					<a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
	...
	<div className="flex items-center p-2 mt-12 space-x-4 justify-self-end">
		<img src="https://img.freepik.com/free-psd/3d-illustration-person-with-sunglasses_23-2149436188.jpg?size=338&ext=jpg&ga=GA1.1.553209589.1714608000&semt=sph" alt="" className="w-12 h-12 rounded-lg dark:bg-gray-500" />
		<div>
			<h2 className="text-lg font-semibold">{myName}</h2>
			<span className="flex items-center space-x-1">
				<a rel="noopener noreferrer" href="#" className="text-xs hover:underline dark:text-gray-600">{myRole}</a>
			</span>
		</div>
	</div>
